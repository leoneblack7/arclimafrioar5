...
export default function Admin() {
  ...
  useEffect(() => {
    const setViewportMeta = () => {
      ...
      if (viewport) {
        viewport.setAttribute('content', 'width=1280, initial-scale=0.3, maximum-scale=0.3, user-scalable=0');
      } else {
        const meta = document.createElement('meta');
        meta.name = 'viewport';
        meta.content = 'width=1280, initial-scale=0.3, maximum-scale=0.3, user-scalable=0';
